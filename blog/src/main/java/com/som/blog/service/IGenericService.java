...
public interface IGenericService<T extends DomainObject> {
     ...
     * @throws GeneralServiceException  If service fails to delete entity
     ...
     * @throws GeneralServiceException  If domain or DB error occurs
     * @throws IllegalArgumentException If entity is <code>null</code>
     */
     ...
     * @throws IllegalArgumentException If ids is <code>null</code>
     */
    public List<T> getEntities(List<Long> ids)
            throws IllegalArgumentException;
