...
import com.som.blog.config.ContextProfile;
...
public abstract class AbstractGenericServiceTest<T extends DomainObject> {
     ...
     */
    protected static GenericXmlApplicationContext appContext;
    ...
    public static void obtainApplicationContext() {
        appContext = ApplicationConfig.getSpringApplicationContext(ContextProfile.SERVICES_FAKE);
