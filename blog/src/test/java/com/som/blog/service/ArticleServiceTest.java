...
public class ArticleServiceTest extends AbstractGenericServiceTest<Article> {
    ...
    protected IArticleService getService() {
        return (IArticleService) appContext.getBean(ServiceName.articleService.name());
    }
    ...
    protected Article getFirstEntity() {
        User author = new User("login1", "pass", "email", UserRole.USER);
        author.setId(1L);
    ...
    protected Article getSecondEntity() {
        User author2 = new User("login2", "pass", "email2", UserRole.USER);
        author2.setId(2L);
    ...
    public void testGetArticleByAuthor() throws Exception {
        User author = new User("user1", "qwerty", "my_email", UserRole.USER);
        author.setId(3L);
