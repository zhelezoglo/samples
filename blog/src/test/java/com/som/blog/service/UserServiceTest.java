...
public class UserServiceTest extends AbstractGenericServiceTest<User> {
    ...
    protected IUserService getUserService() {
        return (IUserService) appContext.getBean(ServiceName.userService.name());
    }
    ...
    protected User getFirstEntity() {
        User user = new User("aaa", "aaa", "ddd", UserRole.USER);
        return user;
    }
    ...
    protected User getSecondEntity() {
        User user = new User("bbb", "bbb", "eee", UserRole.USER);
        return user;
    }
